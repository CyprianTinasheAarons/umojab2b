        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold tracking-tight mb-3">
              Coming Soon: Umoja B2B Marketplace
            </h2>
            <p className="text-lg text-muted-foreground">
              We&apos;re building a revolutionary B2B marketplace to connect
              African businesses. Join the waitlist to be notified when we
              launch.
            </p>
          </div>
          ...
          <Card className="overflow-hidden hover:shadow-lg transition-shadow">
            <Image
              ...
              alt="Umoja B2B Marketplace Coming Soon"
              width={1200}
              height={400}
              className="object-cover w-full h-[300px] opacity-75"
            />
